...
// then open http://localhost:8099 (PORT=8100 for a second origin). Serves the tracker folder as GitHub Pages would.
...
}).listen(+process.env.PORT || 8099, function () { console.log('tracker on http://localhost:' + this.address().port); });
