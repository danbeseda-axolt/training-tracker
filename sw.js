/* Ledger service worker: app shell only. Never touches the GitHub API.
   ...
   The modules are imported with a version query (engine.js?v=5-4), and the
...
const VERSION = 'ledger-v5-4';
const SHELL = ['./', './index.html', './engine.js?v=5-4', './sync.js?v=5-4', './manifest.json', './icon.svg'];
